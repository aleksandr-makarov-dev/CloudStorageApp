...
function ToastList() {
  ...
  return toasts.map((toast) => (
    ...
    >
      <Toast.Content className="flex items-center gap-4 p-3 overflow-hidden transition-opacity duration-250 ease-[cubic-bezier(0.22,1,0.36,1)] data-behind:opacity-0 data-expanded:opacity-100">
